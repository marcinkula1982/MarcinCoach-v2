...
| Check | Wynik |
|---|---|
| Lokalny backend test suite | `php artisan test` -> `332 passed, 1784 assertions` |
...
| Suunto Sports Tracker test bridge | `php artisan test tests\Feature\Api\SuuntoSportsTrackerIntegrationTest.php` -> `2 passed, 31 assertions`; `php artisan test tests\Feature\Api\IntegrationsParityTest.php tests\Feature\Api\SuuntoSportsTrackerIntegrationTest.php` -> `5 passed, 59 assertions`; aktualny pelny suite `php artisan test` -> `332 passed, 1784 assertions` |
