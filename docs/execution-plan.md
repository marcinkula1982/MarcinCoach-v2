...
| 2026-04-30 | EP-037 | Guard feedbacku dla treningów historycznych | US-PLAN-005, US-PLAN-018, US-IMPORT-011 | `TrainingFeedbackV2Service` rozpoznaje `dateRelation=historical` dla treningów starszych niż 3 dni i nie mówi już, że bieżący plan może iść dalej; zamiast tego oznacza analizę jako archiwalną. Dowód: `php artisan test tests\Feature\Api\WorkoutsTest.php --filter=workout_feedback` -> 2 passed, 37 assertions. Pełne plan-vs-actual pozostaje w EP-038. |
